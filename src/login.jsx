        ...
        <>
            <div className="max-w-sm space-y-3 m-auto">
                <div className="relative">
                    <input type="text" className="peer py-2.5 sm:py-3 px-4 ps-11 block w-full bg-gray-100 border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Enter name"/>
